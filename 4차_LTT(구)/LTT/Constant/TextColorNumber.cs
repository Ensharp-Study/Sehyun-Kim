...
namespace LTT.Constant
{
    internal class TextColorNumber
    {
                    ...
                    switch (number)
                    {
                        ...
                        case 6:
                            ...
                            if (search.Key == ConsoleKey.Enter)
                            {
                                ...
                                Console.Clear();
                                newArrayFromExcelcs.FindDataInExcel(majorinput, divideinput, randomExpression, ProfessorExpression, GradeExpression, numberExpression); //관심과목으로들어가기!!!!!!!
                               //newArrayFromExcelcs.FindDataInExcelRegisterMode(majorinput, divideinput, randomExpression, ProfessorExpression, GradeExpression, numberExpression);
        ...
        public void CallNumberAndColorMenuForRegister(StudentData studentData)
        {
            int number = 0;
            Console.CursorVisible = false;
            bool check = true;
                    ...
                    switch (number)
                    {
                        ...
                        case 6:
                            ...
                            if (search.Key == ConsoleKey.Enter)
                            {
                                ...
                                Console.Clear();
                                newArrayFromExcelcs.FindDataInExcelRegisterMode(majorinput, divideinput, randomExpression, ProfessorExpression, GradeExpression, numberExpression); //수강신청으로들어가기!!!!!!!
                                                                                                                                                                        //newArrayFromExcelcs.FindDataInExcelRegisterMode(majorinput, divideinput, randomExpression, ProfessorExpression, GradeExpression, numberExpression);
